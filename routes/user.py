...
async def update_user_profile_path(user_id: int, data: UserUpdateScheme, session: AsyncSession = Depends(get_session)):
    return await update_user_profile(user_id, data, session)
